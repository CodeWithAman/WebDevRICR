...
const categories = [
  ...
  { key: "jewelery", label: "Jewelry", icon: FaGem },
    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 text-xs font-semibold tracking-wide px-3 py-1.5 rounded-full font-mono">
              NEW DROPS WEEKLY
            </span>

            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mt-5 leading-[1.1]">
              Good finds, <span className="text-blue-600">fairly priced.</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-8">
              <Link
                to="/products"
                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3.5 rounded-xl shadow-lg shadow-blue-600/20 transition"
              >
      ...
      <section className="max-w-5xl mx-auto px-6 -mt-2 mb-16 relative z-10">
        <div className="receipt-edge bg-slate-900 text-slate-100 rounded-sm py-6 px-6 sm:px-10 grid grid-cols-2 sm:grid-cols-4 gap-6 font-mono shadow-xl">
          {trustItems.map((item) => (
            <div key={item.label}>
              <p className="text-[11px] sm:text-xs font-bold tracking-wider">
                {item.label}
              </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {categories.map((cat) => (
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-blue-50 group-hover:bg-blue-600 flex items-center justify-center transition">
                <cat.icon className="text-xl text-blue-600 group-hover:text-white transition" />
              </div>
      ...
      {/* CTA */}
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="bg-blue-600 rounded-3xl px-8 py-12 sm:py-16 text-center relative overflow-hidden">
          ...
          <Link
            to="/products"
            className="inline-flex items-center gap-2 bg-white text-blue-600 font-semibold px-6 py-3 rounded-xl mt-7 hover:bg-blue-50 transition"
          >
